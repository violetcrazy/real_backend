$(document).ready(function () {
    ...
    $('.block-upload-img .thumbnail-img input').change(function () {
        if (!process) {
            ...
            var type_upload_default = $('#type_upload_default').val();
            var form_data = new FormData();
            form_data.append('file', file_data);
            form_data.append('type_upload', type_upload);
            form_data.append('type_upload_default', type_upload_default);
    ...
    $('.block-upload-img-default .thumbnail-img input').change(function () {
        if (!process) {
            process = true;
