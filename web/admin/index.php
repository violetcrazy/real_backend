...
try {
    ...
    require_once ROOT . '/app/admin/config/parameters.php';
    ...
    $di->setShared('db', function() use ($config) {
        ...
        if ($config->db->debug) {
            ...
            $logger = new \Phalcon\Logger\Adapter\File(ROOT . '/log/admin_db_master.log');
    ...
    $di->setShared('db_slave', function() use ($config) {
        ...
        if ($config->db_slave->debug) {
            $e = new \Phalcon\Events\Manager();
            $logger = new \Phalcon\Logger\Adapter\File(ROOT . '/log/admin_db_slave.log');
    ...
    $di->setShared('router', function() {
        ...
        require_once ROOT . '/app/admin/config/routers.php';
    ...
    $di->setShared('logger', function() {
        $logger = new \Phalcon\Logger\Adapter\File(ROOT . '/log/admin_error.log');
        return $logger;
    });
