    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="page-header">
                <a href="{{ url({'for': 'load_attribute_add_ajax'}) }}?module_attr={{ constant('\ITECH\Data\Lib\Constant::ATTRIBUTE_MODULE_APARTMENT') }}" class="btn btn-primary pull-right btn-add-attr">
