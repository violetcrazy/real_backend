                    ...
                    {% for item in result %}
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ url({'for': 'user_delete', 'query': '?' ~ http_build_query({'id': item.id, 'q': q, 'filter': 'admin_editor_list'})}) }}" onclick="return confirm('Đồng ý xoá?');" class="btn btn-xs btn-bricky">
