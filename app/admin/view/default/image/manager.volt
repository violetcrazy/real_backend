...
{% block content %}
    ...
    <div class="wrap-filenmanager">
        ...
        <div class="tab-content body-area">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6">
                                {#<select name="type" id="" class="form-control">#}
                                    ...
                                    {#<option value="jpg">WORD</option>#}
                                    {#<option value="jpg">Excel</option>#}
                                    {#<option value="jpg">Khác</option>#}
                                {#</select>#}
                            </div>
            ...
            <div role="tabpanel" class="tab-pane" id="upload-tool">
            ...
            var out = '\
                ...
                <form action="" class="form-edit-media">\
                    ...
                    <div class=" action-bottom">\
                        <button class="btn btn-block btn-success btn-block">Lưu</button>\
                    </div>\
                </form>';
            return out;
        }
    ...
    <link rel="stylesheet" href="/asset/upload_tool/css/style-admin.css">
    <script type="text/javascript" src="asset/upload_tool/js/dropzone.js"></script>
    <script type="text/javascript" src="asset/upload_tool/js/upload_ajax.js"></script>
{% endblock %}
