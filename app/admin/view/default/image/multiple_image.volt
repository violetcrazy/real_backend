...
{% block content %}
    <div class="wrap-filenmanager">
        ...
        <ul class="nav nav-tabs header-area" role="tablist">
            <li role="presentation">
                <a href="#list" aria-controls="list" role="tab" data-toggle="tab" id="view-list">Thư viện ảnh</a>
            </li>
            <li class="active" role="presentation">
                <a href="#upload-tool" aria-controls="upload-tool" role="tab" data-toggle="tab" id="tab-upload">Tải ảnh lên <span class="counter_upload"></span></a>
            </li>
            <li class="" role="presentation">
                <a href="#category-list" aria-controls="category-list" role="tab" data-toggle="tab" id="tab-category">Chuyên mục</a>
            </li>
        </ul>
    ...
    <link type="text/css" rel="stylesheet" href="/asset/upload_tool/css/style.css" />
