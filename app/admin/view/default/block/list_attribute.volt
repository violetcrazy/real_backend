...
{% block content %}
    <div class="row">
        ...
        <div class="col-sm-12 m-b-20">
            <a href="{{ url({'for': 'load_attribute_add_ajax'}) }}?module_attr={{ constant('\ITECH\Data\Lib\Constant::ATTRIBUTE_MODULE_BLOCK') }}" class="btn btn-primary float-right btn-add-attr">Thêm thuộc tính</a>
