...
class LinkForm extends \Phalcon\Forms\Form {
    public function initialize($model, $options = array()) {
        ...
        $name->addValidators(array(
            new \Phalcon\Validation\Validator\PresenceOf(array(
                'message' => 'Yêu cầu nhập tên liên kết.'
            ))
        ));
        ...
        $target = new \Phalcon\Forms\Element\Select('target', \ITECH\Data\Lib\Constant::getGroupLinkTarget());
        $this->add($target);
